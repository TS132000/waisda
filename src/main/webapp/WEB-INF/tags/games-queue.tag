...
<div id="games-queue" class="game-queue box span4 ${dynamic == 'true' ? 'dynamic' : 'col'}">
	...
	<section class="reset">
		...
		<p class="box-inner show">Momenteel zijn er geen spel rondes om aan deel te nemen. Start zelf een ronde door één van de kanalen op de <a href="/">hoofdpagina</a> te selecteren.</p>
		<div class="hide">
